...
(function(){/*!
   ...
   * global d4: false
   */
"use strict";var t=this,e={},n=function(t){return t instanceof n?t:this instanceof n?(this.d4Wrapped=t,void 0):new n(t)};"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=n),exports.d4=n):t.d4=n,n.features={},n.parsers={};var r=n.each=n.forEach=function(t,n,r){var i,s,a=Array.prototype.forEach;if(null!==t)if(a&&t.forEach===a)t.forEach(n,r);else if(t.length===+t.length){for(i=0,s=t.length;s>i;i++)if(n.call(r,t[i],i,t)===e)return}else{var u=d3.keys(t);for(i=0,s=u.length;s>i;i++)if(n.call(r,t[u[i]],u[i],t)===e)return}},i=function(t){throw Error("[d4] "+t)},s=function(t){return r(["configure"],function(e){(!t[e]||n.isNotFunction(t[e]))&&i("The supplied builder does not have a "+e+" function")}),t},a=function(t){return this.builder||(this.builder=s(t.bind(this)())),this},u=function(t,e){e||i("No builder defined");var r=n.merge({width:400,height:400,features:{},mixins:[],xKey:"x",yKey:"y",valueKey:"y",margin:{top:20,right:20,bottom:20,left:40}},t);return a.bind(r)(e),r.accessors=["margin","width","height","x","y","xKey","yKey","valueKey"].concat(t.accessors||[]),r},c=function(t,e){e&&r(d3.keys(t._proxiedFunctions),function(n){r(t._proxiedFunctions[n],function(t){e[n].apply(e,t)})})},o=function(t,e){t.mixins.forEach(function(n){var r=t.features[n].render.bind(t)(t.features[n],e);c(t.features[n],r)})},h=function(t,e){t.builder?(t.builder.configure(t,e),o(t,e)):i("No builder defined")},d=function(t,e){this.svg=d3.select(t).selectAll("svg").data([e]),this.featuresGroup=this.svg.enter().append("svg").append("g").attr("class","featuresGroup").attr("transform","translate("+this.margin.left+","+this.margin.top+")"),this.svg.attr("width",this.width).attr("height",this.height).attr("class","d4"),this.svg.append("defs")},f=function(t,e){t.yKey!==t.valueKey&&(t.valueKey=t.yKey);var r=n.parsers.nestedGroup().x(t.xKey).y(t.yKey).nestKey(t.xKey).value(t.valueKey)(e);return r.data},l=function(t,e){var r,i,s=!1;return e.length>0&&(i=e[0],n.isArray(i)?s=!0:(r=d3.keys(i),0>=r.indexOf("key")+r.indexOf("values")&&(s=!0))),s?f(t,e):e},y=function(t){return function(e){e.each(function(e){e=l(t,e),d.bind(t,this)(e),h(t,e)})}},x=function(t){return t.overrides?t.overrides(this):{}},p=function(t,e,n){n!==void 0?(n=Math.max(Math.min(n,t.length),0),t.splice(n,0,e)):t.push(e)},v=function(t){t._proxiedFunctions={on:[]},t.on=function(){t._proxiedFunctions.on.push(Array.prototype.slice.call(arguments))}},g=function(t){v(t);var e=t.accessors;e&&r(d3.keys(e),function(e){t[e]=function(n){return arguments.length?(t.accessors[e]=n,t):t.accessors[e]}.bind(this)})},b=function(t,e){t||i("You need to supply an object to mixin.");var r=d3.keys(t)[0],s=x.bind(this)(t,r);t[r]=n.merge(t[r](r),s),n.extend(this.features,t),p(this.mixins,r,e),g(this.features[r])},m=function(t){t||i("A name is required in order to mixout a chart feature."),delete this.features[t],this.mixins=this.mixins.filter(function(e){return e!==t})},K=function(t,e){var r=this.features[t];n.isNotFunction(e)&&i("You must supply a continuation function in order to use a chart feature."),r?e.bind(this)(r):i('Could not find feature: "'+t+'", maybe you forgot to mix it in?')};n.baseChart=function(t,e){var n=u(t,e),r=y(n);/*!
    ...
    */
return r.accessors=n.accessors,r.accessors.forEach(function(t){r[t]=function(e){return arguments.length?(n[t]=e,r):n[t]}}),r.using=function(t,e){return K.bind(n)(t,e),r},r.mixin=function(t,e){return b.bind(n)(t,e),r},r.mixout=function(t,e){return m.bind(n)(t,e),r},r.builder=function(t){return s(t.bind(r)(n)),r},r.features=function(){return n.mixins},r},n.functor=function(t){return n.isFunction(t)?t:function(){return t}},n.isArray=Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)},n.isFunction=function(t){return!!(t&&t.constructor&&t.call&&t.apply)},n.isNotFunction=function(t){return!n.isFunction(t)},n.merge=function(t,e){return n.extend(n.extend({},t),e)},n.extend=function(t){return r(Array.prototype.slice.call(arguments,1),function(e){if(e)for(var r in e)e[r]&&e[r].constructor&&e[r].constructor===Object?(t[r]=t[r]||{},n.extend(t[r],e[r])):t[r]=e[r]}),t}}).call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
"use strict";var t=function(){var t=function(t,e){var n=t.map(function(t){return t.values.map(function(t){return t[e]}.bind(this))}.bind(this));return d3.merge(n)},e=function(e,n){if(!e.x){var r=t(n,e.xKey);e.xRoundBands=e.xRoundBands||.3,e.x=d3.scale.ordinal().domain(r).rangeRoundBands([0,e.width-e.margin.left-e.margin.right],e.xRoundBands)}},n=function(e,n){if(!e.y){var r=t(n,e.yKey),i=d3.extent(r);e.y=d3.scale.linear().domain([Math.min(0,i[0]),i[1]])}e.y.range([e.height-e.margin.top-e.margin.bottom,0]).clamp(!0).nice()},r=function(t,r){e.bind(this)(t,r),n.bind(this)(t,r)},i={configure:function(t,e){r.bind(this)(t,e)}};return i};d4.charts.groupedColumn=function(){var e=d4.baseChart({accessors:["groupsOf"],groupsOf:1},t);return[{bars:d4.features.groupedColumnSeries},{columnLabels:d4.features.groupedColumnLabels},{xAxis:d4.features.xAxis},{yAxis:d4.features.yAxis}].forEach(function(t){e.mixin(t)}),e}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
"use strict";var t=function(){var t=function(t,e){var n=t.map(function(t){return t.values.map(function(t){return t[e]}.bind(this))}.bind(this));return d3.merge(n)},e=function(e,n){if(!e.x){var r=t(n,e.xKey);e.xRoundBands=e.xRoundBands||.3,e.x=d3.scale.ordinal().domain(r).rangeRoundBands([0,e.width-e.margin.left-e.margin.right],e.xRoundBands)}},n=function(e,n){if(!e.y){var r=t(n,e.yKey),i=d3.extent(r);e.y=d3.scale.linear().domain(i)}e.y.range([e.height-e.margin.top-e.margin.bottom,0]).clamp(!0).nice()},r=function(t,r){e.bind(this)(t,r),n.bind(this)(t,r)},i={configure:function(t,e){r.bind(this)(t,e)}};return i};d4.charts.line=function(){var e=d4.baseChart({},t);return[{lineSeries:d4.features.lineSeries},{lineSeriesLabels:d4.features.lineSeriesLabels},{xAxis:d4.features.xAxis},{yAxis:d4.features.yAxis}].forEach(function(t){e.mixin(t)}),e}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
"use strict";var t=function(){var t=function(t,e){var n=t.map(function(t){return t.values.map(function(t){return t[e]}.bind(this))}.bind(this));return d3.merge(n)},e=function(e,n){if(!e.y){var r=t(n,e.yKey);e.yRoundBands=e.yRoundBands||.3,e.y=d3.scale.ordinal().domain(r).rangeRoundBands([e.height-e.margin.top-e.margin.bottom,0],e.yRoundBands)}},n=function(t,e){if(!t.x){var n=d3.extent(d3.merge(e.map(function(e){return d3.extent(e.values,function(e){return e[t.xKey]+(e.y0||0)})})));t.x=d3.scale.linear().domain([Math.min(0,n[0]),n[1]])}t.x.range([0,t.width-t.margin.left-t.margin.right]).clamp(!0).nice()},r=function(t,r){n.bind(this)(t,r),e.bind(this)(t,r)},i={configure:function(t,e){r.bind(this)(t,e)}};return i};d4.charts.row=function(){var e=d4.baseChart({margin:{top:20,right:40,bottom:20,left:40}},t);return[{bars:d4.features.rowSeries},{rowLabels:d4.features.rowLabels},{xAxis:d4.features.xAxis},{yAxis:d4.features.yAxis}].forEach(function(t){e.mixin(t)}),e}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
"use strict";var t=function(){var t=function(t,e){var n=d3.extent(d3.merge(e.map(function(e){return d3.extent(e.values,function(e){return e[t]})})));return d3.scale.linear().domain([Math.min(0,n[0]),n[1]])},e=function(e,n){e.x||(e.x=t(e.xKey,n)),e.x.range([0,e.width-e.margin.left-e.margin.right]).clamp(!0).nice()},n=function(e,n){e.y||(e.y=t(e.yKey,n)),e.y.range([e.height-e.margin.top-e.margin.bottom,0])},r=function(e,n){e.z||(e.z=t(e.zKey,n));var r=5,i=Math.max(r+1,(e.height-e.margin.top-e.margin.bottom)/10);e.z.range([r,i])},i=function(t,i){e.bind(this)(t,i),n.bind(this)(t,i),r.bind(this)(t,i)},s={configure:function(t,e){i.bind(this)(t,e)}};return s};d4.charts.scatterPlot=function(){var e=d4.baseChart({accessors:["z","zKey"],zKey:"z"},t);return[{circles:d4.features.dotSeries},{xAxis:d4.features.xAxis},{yAxis:d4.features.yAxis}].forEach(function(t){e.mixin(t)}),e}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
"use strict";var t=function(){var t=function(t,e){var n=t.map(function(t){return t.values.map(function(t){return t[e]}.bind(this))}.bind(this));return d3.merge(n)},e=function(e,n){if(!e.x){var r=t(n,e.xKey);e.xRoundBands=e.xRoundBands||.3,e.x=d3.scale.ordinal().domain(r).rangeRoundBands([0,e.width-e.margin.left-e.margin.right],e.xRoundBands)}},n=function(t,e){if(!t.y){var n=d3.extent(d3.merge(e.map(function(e){return d3.extent(e.values,function(e){return e[t.yKey]+(e.y0||0)})})));t.y=d3.scale.linear().domain([Math.min(0,n[0]),n[1]])}t.y.range([t.height-t.margin.top-t.margin.bottom,0]).clamp(!0).nice()},r=function(t,r){e.bind(this)(t,r),n.bind(this)(t,r)},i={configure:function(t,e){r.bind(this)(t,e)}};return i};d4.charts.column=d4.charts.stackedColumn=function(){var e=d4.baseChart({},t);return[{bars:d4.features.stackedColumnSeries},{barLabels:d4.features.stackedColumnLabels},{connectors:d4.features.stackedColumnConnectors},{xAxis:d4.features.xAxis},{yAxis:d4.features.yAxis}].forEach(function(t){e.mixin(t)}),e}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
"use strict";var t=function(){return"vertical"},e=function(){return{accessors:{y:function(t){if("vertical"===this.orientation()){var e=t.y0+t.y-Math.min(0,t.y);return this.y(e)}return this.y(t[this.yKey])},x:function(t){if("vertical"===this.orientation())return this.x(t[this.xKey]);var e=t.y0+t.y-Math.max(0,t.y);return this.x(e)},width:function(t){return"vertical"===this.orientation()?this.x.rangeBand():Math.abs(this.x(t.y0)-this.x(t.y0+t.y))},height:function(t){return"vertical"===this.orientation()?Math.abs(this.y(t.y0)-this.y(t.y0+t.y)):this.y.rangeBand()},classes:function(t,e,n){var r=t.y>0?"positive":"negative";return n>0&&0===t.y0&&(r="subtotal"),"bar fill item"+e+" "+r+" "+t[this.yKey]}}}},n=function(){return{accessors:{y:function(t){if("vertical"===this.orientation()){var e=Math.abs(this.y(t.y0)-this.y(t.y0+t.y)),n=t.y0+t.y-Math.max(0,t.y);return this.y(n)-10-e}return this.y(t[this.yKey])+this.y.rangeBand()/2},x:function(t){if("vertical"===this.orientation())return this.x(t[this.xKey])+this.x.rangeBand()/2;var e=t.y0+t.y-Math.max(0,t.y),n=Math.abs(this.x(t.y0)-this.x(t.y0+t.y));return this.x(e)+10+n},text:function(t){return d3.format("").call(this,t[this.valueKey])}}}},r=function(){var t=function(t,e){var n;return"x"===e?[0,t.width-t.margin.left-t.margin.right]:(n=[0,t.height-t.margin.top-t.margin.bottom],"vertical"===t.orientation().toLowerCase()?n.reverse():n)},e=function(e,n,r){if(!e[n]){var i=r.map(function(t){return t.key}.bind(this));e[n]=d3.scale.ordinal().domain(i).rangeRoundBands(t.bind(this)(e,n),e.xRoundBands||.3)}},n=function(e,n,r){if(!e[n]){var i=d3.extent(d3.merge(r.map(function(t){return d3.extent(t.values,function(t){return t.y+t.y0})})));i[0]=Math.min(0,i[0]),e[n]=d3.scale.linear().domain(i)}e[n].range(t.bind(this)(e,n)).clamp(!0).nice()},r=function(t,r){"vertical"===t.orientation().toLowerCase()?(e.bind(this)(t,"x",r),n.bind(this)(t,"y",r)):(e.bind(this)(t,"y",r),n.bind(this)(t,"x",r))},i={configure:function(t,e){r.bind(this)(t,e)}};return i};d4.charts.waterfall=function(){var i=d4.baseChart({accessors:["orientation"],orientation:t},r);return[{bars:d4.features.stackedColumnSeries,overrides:e},{connectors:d4.features.waterfallConnectors},{columnLabels:d4.features.stackedColumnLabels,overrides:n},{xAxis:d4.features.xAxis},{yAxis:d4.features.yAxis}].forEach(function(t){i.mixin(t)}),i}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
"use strict";d4.features.arrow=function(t){return{accessors:{tipSize:function(){return 6},x1:function(){return this.x(0)},x2:function(){return this.x(this.width-this.margin.left-this.margin.right)},y1:function(){return this.y(0)},y2:function(){return this.y(this.height-this.margin.top-this.margin.bottom)}},render:function(e){var n=this.svg.select("defs");n.append("marker").attr("id",t+"-end").attr("viewBox","0 0 10 10").attr("refX",10).attr("refY",5).attr("markerWidth",e.accessors.tipSize.bind(this)).attr("markerHeight",e.accessors.tipSize.bind(this)).attr("orient","auto").append("path").attr("d","M 0 0 L 10 5 L 0 10 z"),n.append("marker").attr("id",t+"-start").attr("viewBox","0 0 10 10").attr("refX",10).attr("refY",5).attr("markerWidth",-e.accessors.tipSize.bind(this)()).attr("markerHeight",e.accessors.tipSize.bind(this)).attr("orient","auto").append("path").attr("d","M 0 0 L 10 5 L 0 10 z"),this.featuresGroup.append("g").attr("class",t);var r=this.svg.select("."+t).append("line").attr("class","line").attr("x1",e.accessors.x1.bind(this)).attr("x2",e.accessors.x2.bind(this)).attr("y1",e.accessors.y1.bind(this)).attr("y2",e.accessors.y2.bind(this)).attr("marker-end","url(#"+t+"-end)");return r}}}}.call(this),function(){/*!
   ...
   * global d4: false
   */
"use strict";d4.features.dotSeries=function(t){return{accessors:{cx:function(t){return this.x(t[this.xKey])},cy:function(t){return this.y(t[this.yKey])},r:function(t){return this.z(t[this.zKey])},classes:function(t,e){return"dot series"+e+" fill"}},render:function(e,n){this.featuresGroup.append("g").attr("class",t);var r=this.svg.select("."+t).selectAll(".group").data(n).enter().append("g").attr("class",function(t,e){return"series"+e+" "+this.yKey}.bind(this)),i=r.selectAll("circle").data(function(t){return t.values}.bind(this));return i.enter().append("circle"),i.exit().remove(),i.attr("class",e.accessors.classes.bind(this)).attr("r",e.accessors.r.bind(this)).attr("cx",e.accessors.cx.bind(this)).attr("cy",e.accessors.cy.bind(this)),i}}}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
...
"use strict";d4.features.referenceLine=function(t){return{accessors:{x1:function(){return this.x(0)},x2:function(){return this.x(this.width-this.margin.left-this.margin.right)},y1:function(){return this.y(0)},y2:function(){return this.y(this.height)}},render:function(e){this.featuresGroup.append("g").attr("class",t);var n=this.svg.select("."+t).append("line").attr("class","line").attr("x1",e.accessors.x1.bind(this)).attr("x2",e.accessors.x2.bind(this)).attr("y1",e.accessors.y1.bind(this)).attr("y2",e.accessors.y2.bind(this));return n}}}}.call(this),function(){/*!
   ...
   * global d4: false
   */
"use strict";d4.features.rowLabels=function(t){return{accessors:{x:function(t){var e=(Math.abs(this.x(t[this.xKey]))+this.x(t[this.xKey]))/2;return Math.max(this.x(0),e)+10},y:function(t){return this.y(t[this.yKey])+this.y.rangeBand()/2},text:function(t){return d3.format("").call(this,t[this.xKey])}},render:function(e,n){this.featuresGroup.append("g").attr("class",t);var r=this.svg.select("."+t).selectAll(".group").data(n).enter().append("g").attr("class",function(t,e){return"series"+e+" "+this.xKey}.bind(this)),i=r.selectAll("text").data(function(t){return t.values}.bind(this));return i.exit().remove(),i.enter().append("text").text(e.accessors.text.bind(this)).attr("class","column-label").attr("y",e.accessors.y.bind(this)).attr("x",e.accessors.x.bind(this)),i}}}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
"use strict";d4.features.rowSeries=function(t){var e=function(t){return t>0?"positive":"negative"};return{accessors:{x:function(t){var e=t[this.xKey]-Math.max(0,t[this.xKey]);return this.x(e)},y:function(t){return this.y(t[this.yKey])},width:function(t){return Math.abs(this.x(t[this.xKey])-this.x(0))},height:function(){return this.y.rangeBand()},classes:function(t,n){return"bar fill item"+n+" "+e(t.y)+" "+t[this.xKey]}},render:function(e,n){this.featuresGroup.append("g").attr("class",t);var r=this.svg.select("."+t).selectAll(".group").data(n).enter().append("g").attr("class",function(t,e){return"series"+e+" "+this.yKey}.bind(this)),i=r.selectAll("rect").data(function(t){return t.values}.bind(this));return i.enter().append("rect").attr("class",e.accessors.classes.bind(this)).attr("x",e.accessors.x.bind(this)).attr("y",e.accessors.y.bind(this)).attr("width",e.accessors.width.bind(this)).attr("height",e.accessors.height.bind(this)),i}}}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
/*!
