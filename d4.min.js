...
"use strict";var t=function(){var t=function(t,e){var n=t.map(function(t){return t.values.map(function(t){return t[e]}.bind(this))}.bind(this));return d3.merge(n)},e=function(e,n){if(!e.x){var r=t(n,e.xKey);e.xRoundBands=e.xRoundBands||.3,e.x=d3.scale.ordinal().domain(r).rangeRoundBands([0,e.width-e.margin.left-e.margin.right],e.xRoundBands)}},n=function(e,n){if(!e.y){var r=t(n,e.yKey),i=d3.extent(r);e.y=d3.scale.linear().domain([Math.min(0,i[0]),i[1]])}e.y.range([e.height-e.margin.top-e.margin.bottom,0]).clamp(!0).nice()},r=function(t,r){e.bind(this)(t,r),n.bind(this)(t,r)},i={configure:function(t,e){r.bind(this)(t,e)}};return i};d4.groupedColumnChart=function(){var e=d4.baseChart({accessors:["groupsOf"],groupsOf:1},t);return[{bars:d4.features.groupedColumnSeries},{columnLabels:d4.features.groupedColumnLabels},{xAxis:d4.features.xAxis},{yAxis:d4.features.yAxis}].forEach(function(t){e.mixin(t)}),e}}.call(this),function(){/*!
   ...
   * global d4: false
   */
"use strict";var t=function(){var t=function(t,e){var n=t.map(function(t){return t.values.map(function(t){return t[e]}.bind(this))}.bind(this));return d3.merge(n)},e=function(e,n){if(!e.x){var r=t(n,e.xKey);e.xRoundBands=e.xRoundBands||.3,e.x=d3.scale.ordinal().domain(r).rangeRoundBands([0,e.width-e.margin.left-e.margin.right],e.xRoundBands)}},n=function(e,n){if(!e.y){var r=t(n,e.yKey),i=d3.extent(r);e.y=d3.scale.linear().domain(i)}e.y.range([e.height-e.margin.top-e.margin.bottom,0]).clamp(!0).nice()},r=function(t,r){e.bind(this)(t,r),n.bind(this)(t,r)},i={configure:function(t,e){r.bind(this)(t,e)}};return i};d4.lineChart=function(){var e=d4.baseChart({},t);return[{lineSeries:d4.features.lineSeries},{lineSeriesLabels:d4.features.lineSeriesLabels},{xAxis:d4.features.xAxis},{yAxis:d4.features.yAxis}].forEach(function(t){e.mixin(t)}),e}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
"use strict";var t=function(){var t=function(t,e){var n=t.map(function(t){return t.values.map(function(t){return t[e]}.bind(this))}.bind(this));return d3.merge(n)},e=function(e,n){if(!e.y){var r=t(n,e.yKey);e.yRoundBands=e.yRoundBands||.3,e.y=d3.scale.ordinal().domain(r).rangeRoundBands([e.height-e.margin.top-e.margin.bottom,0],e.yRoundBands)}},n=function(t,e){if(!t.x){var n=d3.extent(d3.merge(e.map(function(e){return d3.extent(e.values,function(e){return e[t.xKey]+(e.y0||0)})})));t.x=d3.scale.linear().domain([Math.min(0,n[0]),n[1]])}t.x.range([0,t.width-t.margin.left-t.margin.right]).clamp(!0).nice()},r=function(t,r){n.bind(this)(t,r),e.bind(this)(t,r)},i={configure:function(t,e){r.bind(this)(t,e)}};return i};d4.rowChart=function(){var e=d4.baseChart({margin:{top:20,right:40,bottom:20,left:40}},t);return[{bars:d4.features.rowSeries},{rowLabels:d4.features.rowLabels},{xAxis:d4.features.xAxis},{yAxis:d4.features.yAxis}].forEach(function(t){e.mixin(t)}),e}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
"use strict";var t=function(){var t=function(t,e){var n=d3.extent(d3.merge(e.map(function(e){return d3.extent(e.values,function(e){return e[t]})})));return d3.scale.linear().domain([Math.min(0,n[0]),n[1]])},e=function(e,n){e.x||(e.x=t(e.xKey,n)),e.x.range([0,e.width-e.margin.left-e.margin.right]).clamp(!0).nice()},n=function(e,n){e.y||(e.y=t(e.yKey,n)),e.y.range([e.height-e.margin.top-e.margin.bottom,0])},r=function(e,n){e.z||(e.z=t(e.zKey,n));var r=5,i=Math.max(r+1,(e.height-e.margin.top-e.margin.bottom)/10);e.z.range([r,i])},i=function(t,i){e.bind(this)(t,i),n.bind(this)(t,i),r.bind(this)(t,i)},s={configure:function(t,e){i.bind(this)(t,e)}};return s};d4.scatterPlot=function(){var e=d4.baseChart({accessors:["z","zKey"],zKey:"z"},t);return[{circles:d4.features.dotSeries},{xAxis:d4.features.xAxis},{yAxis:d4.features.yAxis}].forEach(function(t){e.mixin(t)}),e}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
"use strict";var t=function(){var t=function(t,e){var n=t.map(function(t){return t.values.map(function(t){return t[e]}.bind(this))}.bind(this));return d3.merge(n)},e=function(e,n){if(!e.x){var r=t(n,e.xKey);e.xRoundBands=e.xRoundBands||.3,e.x=d3.scale.ordinal().domain(r).rangeRoundBands([0,e.width-e.margin.left-e.margin.right],e.xRoundBands)}},n=function(t,e){if(!t.y){var n=d3.extent(d3.merge(e.map(function(e){return d3.extent(e.values,function(e){return e[t.yKey]+(e.y0||0)})})));t.y=d3.scale.linear().domain([Math.min(0,n[0]),n[1]])}t.y.range([t.height-t.margin.top-t.margin.bottom,0]).clamp(!0).nice()},r=function(t,r){e.bind(this)(t,r),n.bind(this)(t,r)},i={configure:function(t,e){r.bind(this)(t,e)}};return i};d4.columnChart=d4.stackedColumnChart=function(){var e=d4.baseChart({},t);return[{bars:d4.features.stackedColumnSeries},{barLabels:d4.features.stackedColumnLabels},{connectors:d4.features.stackedColumnConnectors},{xAxis:d4.features.xAxis},{yAxis:d4.features.yAxis}].forEach(function(t){e.mixin(t)}),e}}.call(this),function(){/*!
   * global d3: false
   * global d4: false
   */
